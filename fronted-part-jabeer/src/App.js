  ...
  render() {
    ...
    return (
      ...
      {/*<div class='container-fluid'>
        < a class='navbar-brand' href='a'><img src='pic2.jpg>' alt='logo' /></a>
      </div>*/}
          ...
          {currentUser ? (
            ...
            < Link to={"/search"} className="nav-link">
              ...
              <li className="nav-item">
                <Link to={"/profile"} className="nav-link" style={{"marginLeft": "450px"}}>
            ...
            <div className="navbar-nav ml-auto">
              <li className="nav-bar">
                <Link to={"/login"} className="nav-link"  style={{"marginLeft": "700px"}}>
                  Login
                </Link>
              </li>
