...
class Searchpage extends Component{
    ...
    render() {
        return (
            ...
            <div className = "row" >
                <div className = "card col-md-4 offset-md-4 offset-md-4" style={{background:"lightseagreen",borderRadius:"50px"}}>                
                   <center>                   
               ...
               <h1 >Flight Search</h1>
                ...
                <label> Destination:      
                <input type="text" style={{marginLeft:"6px"}} required pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter on alphabets only. ')" name="destination" value={this.state.destination} onChange={this.changeHandler2}/> </label>                
                <br/><br/>
                <label> Date: <input type="text" style={{marginLeft:"10px"}}  required pattern="^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[13-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$"
